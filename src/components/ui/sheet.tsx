...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-navy-950/25 backdrop-blur-2xl data-[state=open]:animate-overlay-enter data-[state=closed]:animate-overlay-exit",
      className,
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition-none data-[state=open]:animate-menu-enter data-[state=closed]:animate-menu-exit",
  {
    variants: {
      side: {
